...
class OdomEstimationNode: public rclcpp::Node
{
  ...
  private:
    ...
    void lidarSurfHandler(const sensor_msgs::msg::PointCloud2::ConstSharedPtr laserCloudMsg);
    void lidarEdgeHandler(const sensor_msgs::msg::PointCloud2::ConstSharedPtr laserCloudMsg);
